...
function generateRuleBasedResponse(
  ...
  if (q.includes('benefit') || q.includes('how much') || q.includes('amount')) {
    if (eligibleSchemes.length === 0) {
  ...
  if (q.includes('requirement') || q.includes('eligibility') || q.includes('qualify')) {
    if (eligibleSchemes.length === 0) {
  ...
  // Default response
  return `I'm here to help you discover and understand government schemes suited to your profile as a ${profile.age}y ${profile.occupation.replace('_', ' ')} in ${profile.state}.\n\nYou can ask me:\n✓ "Which schemes am I eligible for?"\n✓ "How do I apply for [scheme name]?"\n✓ "What benefits will I get?"\n✓ "What documents do I need?"\n\nWhat would you like to know?`;
}
